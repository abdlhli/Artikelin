                    ...
                    <div class="overflow-hidden">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <div class="flex items-center justify-between">
                                ...
                                <button type="button" data-modal-target="ModalTambahArtikel"
                                    data-modal-toggle="ModalTambahArtikel"
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex">
                                            <button id="TombolModalUpdateArtikel" data-modal-toggle="ModalUpdateArtikel"
                                            ...
                                            <button id="TombolModalDeleteArtikel" data-modal-toggle="ModalDeleteArtikel"
